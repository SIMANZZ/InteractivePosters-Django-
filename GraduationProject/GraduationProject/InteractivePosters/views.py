...
def main(request):
    ...
    ACmachinesimages_dataSync = [
        ...
        },
        {
            ...
            "imageCommon_adress": static('rotor_and_stator_of_turbogenerator_common.html'),
            "imageInteractive_adress": static('rotor_and_stator_of_turbogenerator_interactive.html'),
            "imageTest_adress": static('rotor_and_stator_of_turbogenerator_test.html')
        },
        {
