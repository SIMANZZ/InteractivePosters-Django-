document.addEventListener('DOMContentLoaded', () => {
    ...
    const videoNames = [ 'АД с расщепленными полюсами.mp4', 'Асинхронный двигатель.mp4', 'Вал.mp4', 'Взаимоиндукция.mp4',
        ...
        'Производство обмоток статоров турбогенераторов и гидрогенераторов.mp4', 'Ротор.mp4', 'Сельсин 1.mp4', 'Сельсин 2.mp4', 'Сельсин(ЭтоИнтересно).mp4',
        'Сердечник.mp4', 'Сила тока.mp4', 'Синхронный двигатель.mp4', 'СКВТ.mp4', 'Соединение звездой.mp4', 'Соединение треугольником.mp4',
        'Сопротивление.mp4', 'Тахогенератор 1.mp4', 'Тахогенератор 2.mp4', 'Тахогенератор(ЭтоИнтересно).mp4', 'Универсальный коллекторный двигатель 1.mp4',
        'Универсальный коллекторный двигатель 2.mp4', 'Универсальный коллекторный двигатель(ЭтоИнтересно).mp4', 'Универсальный коллекторный.mp4',
        'Шаговые двигатели(ЭтоИнтересно).mp4', 'Шаговый двигатель 1.mp4', 'Шаговый двигатель 2.mp4', 'Щетка.mp4', 'Электрическая машина.mp4',
        'Электрический генератор.mp4', 'Электрический двигатель.mp4', 'Электрический ток.mp4', 'Электро-магнитная индукция.mp4'];
